...
def main():
    ...
    circle2 = CircleShape(150, 200, 50, "rgb(0,255,0)", 1)
    circle3 = CircleShape(150, 100, 50, "rgb(50,255,0)", 1)

    rectangle1 = RectangleShape(250, 50, 50, 50, "rgb(0,0,255)", 1)
    rectangle2 = RectangleShape(350, 50, 50, 60, "rgb(125,215,0)", 1)
    rectangle3 = RectangleShape(250, 100, 50, 60, "rgb(125,0,0)", 1)

    ellipse1 = EllipseShape(200, 50, 50, 50, "rgb(10,10,110)", 0.8)
    ellipse2 = EllipseShape(400, 100, 50, 80, "rgb(50,10,20)", 0.5)
    ellipse3 = EllipseShape(100, 200, 30, 35, "rgb(25,0,200)", 1)


    svg_canvas = SvgCanvas(500, 500, [circle1, circle2, circle3, rectangle1, rectangle2, rectangle3, ellipse1, ellipse2, ellipse3])
